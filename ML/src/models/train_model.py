...
max_features = 10
# Find the best features for training using decision tree
...
# Perform grid search for each feature set to find the best model
...
X_train.drop(columns=["participant"], axis=1)
X_test.drop(columns=["participant"], axis=1)
